...
to bring up a local testing environment
2. `$ cd postgresql9-server/tests/provisioning/site-testing-local`
3. `$ vagrant up`
4. `$ cd ..`
...
1. `$ cd postgresql9-server/tests/provisioning`
...
Results for these tests can be found [here](https://semaphoreci.com/bas-ansible-roles-collection/postgresql9-server).
